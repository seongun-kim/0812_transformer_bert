...
def plot_attention_weights(attention, sentence, result, layer):
  ...
  for head in range(attention.shape[0]):
    ...
    ax.matshow(attention[head][:-1, :], cmap='coolwarm')
    ...
    ax.set_yticklabels([tokenizer_en.decode([i]) for i in result 
                       ...
                       fontdict=fontdict, fontproperties=fontprop)
...
#translate('나는 퇴근하고 싶다.', plot='decoder_layer4_block1')
translate('한국 사람들은 업무가 끝나도 상관이 퇴근하기 전에는 사무실을 떠나려 하지 않는다.', plot='decoder_layer1_block1')
#translate('오늘 날씨가 너무 덥다.', plot='decoder_layer4_block1')
#translate('그러나 불충분한 증거 확보로 수사에 어려움이 있다.', plot='decoder_layer4_block1')
#translate('삼성 실습 교육은 정말 즐겁습니다!', plot='decoder_layer4_block1')